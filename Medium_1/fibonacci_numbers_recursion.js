 ...
 * following function is a recursive function that computes the sum of all
 ...
 * 2. It has an ending condition — e.g., if (num === 1), in the sum function
 *    above.
 ...
 *
 * Problem:
 * Given a number, finalFibonacci, return that fibonacci number in the sequence,
 * all while using a recursive function.
 *
 * Input: Number
 * Output: Number
 *
