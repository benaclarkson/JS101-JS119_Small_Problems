...
/**
 * Solution:
 * The issue was that `sort()` was called on the input array without any
 * callback function to properly sort the grades in ascending order. Without
 * the proper callback, `sort()` coerces each element to a string and compares
 * them all by their Unicode code points.
 */