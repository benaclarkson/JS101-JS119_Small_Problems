 ...
 * looks correct, but the output when we rolled values 1 and 20 doesn't make
...
/**
 * Solution:
 * The above code fails due to the fact that the `break` statements were missing
 * from the `switch` statement, causing the code to "fall through" and output
 * the unwanted statements.
 */